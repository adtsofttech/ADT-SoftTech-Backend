...
export const productsTable = pgTable("cms_products", {
  ...
  iframeEmbed: text("iframe_embed").notNull().default(""),
  ...
  homepageBusinessValue: text("homepage_business_value").notNull().default(""),
  homepageCapabilities: jsonb("homepage_capabilities").$type<string[]>().notNull().default([]),
